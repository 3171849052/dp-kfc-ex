"""Small tensor helpers for the Exp24 head-only BK engine."""
...
def layernorm_per_example_gradient(
    ...
    result = {module.weight: weight.reshape(n, *module.weight.shape)}
    if module.bias is not None:
        result[module.bias] = bias.reshape(n, *module.bias.shape)
    return result
