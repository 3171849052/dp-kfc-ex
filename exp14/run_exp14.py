"""Real MNIST DP training; --smoke is one zero-noise batch for each beta."""
...
from exp14.builders import synthetic_cache, build_from_cache
...
def save_config(output, sigma, epochs, seeds, train_size, smoke):
    ...
    config = dict(dataset='MNIST', model='dp_kfac.models.SimpleCNN', betas=cfg.BETAS, estimator='KFAC-U',
        ...
        preconditioner_build_seconds='cache + curvature + factor power',
